...
// Cek apakah ada keyword yang dikirimkan
if (isset($_GET["keyword"])) {
  $keyword = $_GET["keyword"];
  // Modifikasi query untuk mencari data yang sesuai dengan keyword
            ...
            <div
              ...
              <div class="w-full md:w-1/2">
                <form class="flex items-center">
                  ...
                  <a href="./add-users.php" type="button"
                ...
                <tbody>
                  <?php foreach ($usersOnCurrentPage as $user): ?>
                    <tr class="border-b hover:bg-gray-100">
                      ...
                      <td class="px-4 py-3">
                        <a href="./edits-users.php?uid=<?= $user['id'] ?>" type="button"
                        ...
                        <!-- <div id="popup-modal-delete" class="popup-modal"> -->
                        <button data-modal-target="popup-modal-delete-<?= $user['id'] ?>"
                          data-modal-toggle="popup-modal-delete-<?= $user['id'] ?>" type="button"
