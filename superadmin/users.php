                ...
                <tbody>
                  <?php foreach ($users as $user) : ?>
                    <tr class="border-b hover:bg-gray-100">
                      <th scope="row" class="px-4 py-3 px-2 py-3 font-medium text-gray-900 whitespace-nowrap"><?= $user['id'] ?></th>
                      <td class="px-4 py-3 px-2 py-3"><?= $user['nama_user'] ?></td>
                      <td class="px-4 py-3 px-2 py-3"><?= $user['email'] ?></td>
