...
<head>
  ...
  <title>Mahasiswa | PBL Vokasi</title>
      ...
      <section class="bg-gray-50 p-3 sm:p-5">
        <div class="mx-auto max-w-screen-xl px-4 lg:px-12">
          ...
          <?php if (!empty($_GET['info'])) : ?>
            <!-- Berhasil Dihapus -->
            <?php if ($_GET['info'] == "success-delete") : ?>
            ...
            <!-- Gagal Dihapus -->
            <?php if ($_GET['info'] == "failed-delete") : ?>
          ...
          <div class="bg-white relative shadow-md sm:rounded-lg rounded-lg overflow-hidden">
            <div class="bg-blue-900 flex flex-col md:flex-row items-center justify-between space-y-3 md:space-y-0 md:space-x-4 p-4">
              ...
              <div class="w-full md:w-auto flex flex-col md:flex-row space-y-2 md:space-y-0 items-stretch md:items-center justify-end md:space-x-3 flex-shrink-0">
                ...
                <h2 class="text-xl font-semibold text-white">Daftar Mahasiswa</h2>
              </div>
              ...
              <div class="w-full md:w-1/2">
                <form class="flex items-center">
                  ...
                  <div class="relative w-full">
                    ...
                    <input type="text" name="keyword" id="simple-search" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-green-500 focus:border-blue-900 block w-full pl-10 p-2 mr-3" placeholder="Cari Mahasiswa">
                  </div>
