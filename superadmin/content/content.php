			...
			<?php foreach ($bunches as $bunch) : ?>
				<div class="max-w-full shadow-lg p-6 bg-white border border-blue-800 flex flex-col justify-between items-start rounded-lg">
					<div class="flex justify-between w-full items-center mb-4">
						<a href="./details.php?bid=<?= $bunch['bunch_id'] ?>" class="flex flex-col justify-between">
					...
					<a href="./details.php?bid=<?= $bunch['bunch_id'] ?>" class="inline-flex items-center px-3 py-2 text-xs font-medium text-center text-white bg-blue-800 rounded-lg hover:scale-105 duration-300 ease-in-out mt-2 focus:ring-4 focus:outline-none focus:ring-blue-300">
						Detail Kelompok
