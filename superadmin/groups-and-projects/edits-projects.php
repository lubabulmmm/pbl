            ...
            <div class="py-8 px-4 mx-auto max-w-2xl lg:py-13">
                ...
                <form action="#">
                    <div class="grid gap-4 sm:grid-cols-2 sm:gap-6">
                        ...
                        <div>
                            <label for="name" class="block mb-2 text-sm font-medium text-gray-900">Nama Proyek</label>
                            <input type="text" name="name" id="name" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5" placeholder="Edit Minggu" required="">
                        </div> 
                        <div class="sm:col-span-2">
