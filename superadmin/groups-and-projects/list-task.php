          ...
          <nav class="flex mt-7 mb-5" aria-label="Breadcrumb">
            <ol class="inline-flex items-center space-x-1 md:space-x-2 rtl:space-x-reverse">
              <li class="inline-flex items-center">
                <a href="../superadmin.php" class="inline-flex items-center text-md lg:text-lg font-medium text-gray-900 hover:text-blue-500">
          ...
          <div class="pt-4 border-t border-gray-200">
            <div class="px-1 sm:grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 sm:gap-4 sm:px-0">
              <div>
                ...
                <p class="text-md font-semibold text-red-600 mt-3">To Do (total: <?= $todo_sum ?>)</p>
                    ...
                    <?php foreach ($todo_fetch as $tf) : ?>
                      <li class="pb-3 sm:pb-4 mt-2.5 last:border-0 last:pb-0 first:mt-0 border-b border-gray-200">
                        <div class="flex items-center space-x-4 rtl:space-x-reverse">
                          ...
                          <div class="flex-1 min-w-0 text-xs font-semibold">

                            <?= $tf['task_name'] ?>

                            <p class="text-xs font-semibold text-gray-500 truncate py-1">
                              <span class="bg-amber-200 inline-block rounded-lg px-2 text-amber-600 hover:underline"><a href="edit-task.php?tid=<?= $tf['task_id'] ?>&bid=<?= $_GET['bid'] ?>">Edit</a></span><span class="bg-red-200 inline-block rounded-lg px-2 text-red-600 hover:underline mx-1"><a href="delete-task.php?tid=<?= $tf['task_id'] ?>&bid=<?= $_GET['bid'] ?>">Hapus</a></span>
                            </p>
                          </div>
                        </div>
                      </li>
              ...
              <div>
                ...
                <p class="text-md font-semibold text-amber-500 mt-3">Doing (total: <?= $doing_sum ?>)</p>
              ...
              <div>
                ...
                <p class="text-md font-semibold text-green-500 mt-3">Done (total: <?= $done_sum ?>)</p>
