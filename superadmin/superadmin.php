                ...
                <tbody>
                  <?php foreach ($list_bunchOnCurrentPage as $lb): ?>
                    <tr class="border-b hover:bg-gray-100">
                      ...
                      <td class="px-4 py-3">
                        <a href="./groups-and-projects/details.php?bid=<?= $lb['bunch_id'] ?>" type="button"
                        ...
                        <button data-modal-target="popup-modal-delete-<?= $lb['bunch_id'] ?>"
                          data-modal-toggle="popup-modal-delete-<?= $lb['bunch_id'] ?>" type="button"
                        ...
                        <?php include("./content/delete-modaldash.php") ?>
                        <!-- </div> -->
                      </td>
                    </tr>
                  <?php endforeach; ?>
