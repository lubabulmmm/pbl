...
if (isset($_POST["edit-pass"])) {
  if (pass_user($_POST, $_SESSION['email']) > 0) {
    header("Location: /pbl/user/logout.php");
  } else {
    header("Location: /pbl/superadmin/edit-pass.php?info=failed");
  }
}
            ...
            <ol class="inline-flex items-center space-x-1 md:space-x-2 rtl:space-x-reverse">
              ...
              <li aria-current="page">
                <div class="flex items-center">
                  ...
                  <span class="ms-1 text-lg font-medium text-blue-800 md:ms-2">Edit Password</span>
                </div>
              </li>
            </ol>
          </nav>
