      ...
      <section class="bg-gray-50 p-3 sm:p-5">
        <div class="mx-auto max-w-screen-xl px-4 lg:px-12">
          ...
          <div class="bg-white relative shadow-md sm:rounded-lg rounded-lg overflow-hidden">
            <div
              ...
              <div class="w-full md:w-1/2">
                <form class="flex items-center" method="POST">
                  ...
                  <a href="./add-admin.php" type="button"
                ...
                <tbody>
                  <?php foreach ($adminsOnCurrentPage as $admin): ?>
                    <tr class="border-b hover:bg-gray-100">
                      ...
                      <td class="px-4 py-3">
                        <a href="./edits-users.php?uid=<?= $admin['id'] ?>" type="button"
                        ...
                        <button data-modal-target="popup-modal-delete-<?= $admin['id'] ?>"
                          data-modal-toggle="popup-modal-delete-<?= $admin['id'] ?>" type="button"
                        ...
                        <?php include("./content/delete-modaladmin.php") ?>
                        <!-- </div> -->
                      </td>
                    </tr>
                  <?php endforeach; ?>
            ...
            <nav class="flex flex-col justify-between items-start md:items-end space-y-3 md:space-y-0 p-4"
