              ...
              <div class="w-full md:w-1/2">
                  <form method="post" action="" class="flex items-center">
                      ...
                      <div class="relative w-full">
                          ...
                          <input type="text" name="searchTerm" id="simple-search" class="bg-white border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-green-500 focus:border-amber-500 block w-full pl-10 p-2 mr-3" placeholder="Search" required="">
                      </div>
