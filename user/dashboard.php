    ...
    <div class="rounded-lg mt-14 flex flex-col item-start">
      ...
      <div class="w-full px-4 lg:px-3 py-4">
        ...
        <div class="relative overflow-hidden bg-white sm:rounded-lg">
          <div
            class="flex-row items-center justify-between p-4 space-y-3 md:flex lg:flex-row sm:flex sm:space-y-0 sm:space-x-4">
            ...
            <a href="./profile.php" type="button"
              class="text-white bg-amber-400 focus:ring-4 focus:outline-none focus:ring-amber-300 shadow font-medium rounded-lg text-xs hover:scale-105 duration-300 ease-in-out hover:shadow-md hover:shadow-gray-300 px-4 py-2.5 text-center inline-flex items-center me-2 ">
      ...
      <div class="flex px-7 mb-6 flex-wrap">
        <a href="./groups.php" type="button"
          class="text-amber-500 bg-white focus:ring-4 focus:outline-none focus:ring-amber-300 shadow font-medium rounded-lg text-xs hover:scale-105 duration-300 ml-0 mr-2 my-2 ease-in-out hover:shadow-md hover:shadow-gray-300 px-4 py-2.5 text-center inline-flex items-center me-2 ">
          <svg class="w-4 h-4 me-2" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none"
            viewBox="0 0 20 20">
            <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
              d="M4.333 6.764a3 3 0 1 1 3.141-5.023M2.5 16H1v-2a4 4 0 0 1 4-4m7.379-8.121a3 3 0 1 1 2.976 5M15 10a4 4 0 0 1 4 4v2h-1.761M13 7a3 3 0 1 1-6 0 3 3 0 0 1 6 0Zm-4 6h2a4 4 0 0 1 4 4v2H5v-2a4 4 0 0 1 4-4Z" />
        ...
        <button type="button" data-modal-target="req-list-modal" data-modal-toggle="req-list-modal"
          class="text-green-600 bg-white focus:ring-4 focus:outline-none focus:ring-green-100 shadow font-medium rounded-lg text-xs hover:scale-105 duration-300 m-2 ease-in-out hover:shadow-md hover:shadow-gray-300 px-4 py-2.5 text-center inline-flex items-center me-2 ">
          <svg class="w-4 h-4 me-2" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none"
            viewBox="0 0 24 24">
            <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
        ...
        <a href="#chs"
          class="text-violet-600 bg-white focus:ring-4 focus:outline-none focus:ring-violet-100 shadow font-medium rounded-lg text-xs hover:scale-105 duration-300 m-2 ease-in-out hover:shadow-md hover:shadow-gray-300 px-4 py-2.5 text-center inline-flex items-center me-2">
          <svg class="w-4 h-4 me-2" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none"
            viewBox="0 0 24 24">
        ...
        <form id="liveSearchForm" class="flex items-center" method="POST">
          ...
          <div class="relative w-full">
            ...
            <input type="text" name="keyword" id="simple-search"
              class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-amber-500 block w-full pl-10 p-2 mr-3"
              placeholder="Cari">
          </div>

          <button type="submit" name="cari"
            class="flex items-center justify-center text-white bg-green-600 hover:bg-green-700 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-4 py-2 ml-4">
