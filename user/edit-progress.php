          ...
          <ol class="inline-flex items-center space-x-1 md:space-x-2 rtl:space-x-reverse">
            <li class="inline-flex items-center">
              <a href="./dashboard.php"
                class="inline-flex items-center text-lg font-medium text-gray-700 hover:text-amber-500">
            ...
            <li class="inline-flex items-center">
              <div class="flex items-center">
                <svg class="ms-1 rtl:rotate-180 w-3 h-3 text-gray-400 mx-1" aria-hidden="true"
                  xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 6 10">
                  <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                    d="m1 9 4-4-4-4" />
                </svg>
                <a href="./projects.php?bid=<?= $get_taskinfo[0]['bid'] ?>&id=<?= $get_taskinfo[0]['project_id'] ?>"
                  class="inline-flex items-center text-lg font-medium text-gray-700 hover:text-amber-500">
            ...
            <li class="inline-flex items-center">
              <div class="flex items-center">
                ...
                <a href="./details-progress.php?tid=<?= $_GET['tid'] ?>&id=<?= $_GET['id'] ?>&bid=<?= $get_taskinfo[0]['bid'] ?>"
                  class="inline-flex items-center text-lg font-medium text-gray-700 hover:text-amber-500">
              ...
              <div class="grid gap-4 sm:grid-cols-2 sm:gap-6">
                <div class="sm:col-span-2">
                  ...
                  <input type="text" name="name" id="name"
                    ...
                    placeholder="Tulis Nama Progress.." required="" value="<?= $get_taskinfo[0]['task_name'] ?>">
                </div>
                <div>
                  ...
                  <select id="member" name="member"
                    ...
                    <option value="<?= $get_taskinfo[0]['member_id'] ?>" selected>
                      <?= $get_taskinfo[0]['nama_user'] ?> -
                      <?= $get_taskinfo[0]['member_role'] ?>
                    </option>
                ...
                <div class="sm:col-span-2">
                  ...
                  <textarea id="desc" name="desc" rows="8"
                    class="block p-4 w-full text-sm text-gray-900  rounded-lg border border-gray-300 focus:ring-primary-500 focus:border-primary-500"
                    placeholder="Tulis Deskripsi Kamu.."><?= $get_taskinfo[0]['task_desc'] ?></textarea>
                </div>
              </div>
              <button type="submit" name="submit"
                class="inline-flex items-center px-5 py-2.5 mt-4 sm:mt-6 text-sm font-medium text-center text-white bg-amber-500 rounded-lg focus:ring-4 focus:ring-amber-200 hover:bg-amber-400">
                Edit
              </button>
            </form>
          </div>
