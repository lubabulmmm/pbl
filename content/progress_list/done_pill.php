<!-- PILL PROGRESS 1 -->
<a href="./details-progress.php" class="focus:ring-4 focus:outline-none focus:ring-gray-200 flex items-center justify-between hover:bg-gray-100 w-9/12 px-3 py-2 border-2 border-gray-200 my-1.5 rounded-lg">
  Metode SDLC
