<div class="w-11/12 px-0 lg:pl-4 lg:pr-6 grid grid-cols-1 lg:grid-cols-3 m-0 lg:mt-8 lg:mx-auto">
  ...
  <div class="p-5 mr-0 border shadow-sm border-gray-200 rounded-lg bg-gray-50 col-span-1">
