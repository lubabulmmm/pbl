  ...
  <div class="relative p-7 w-full max-w-md max-h-full">
    <div class="relative bg-white rounded-lg shadow">
      ...
      <div class="p-4 md:p-5 text-center">
        ...
        <h3 class="mb-5 text-md font-normal text-gray-800 ">Tunggu hingga ketua kelompok menyetujui permintaanmu.</h3>
        <form action="" method="post">
          <div class="flex flex-col">
            <div class="mb-6">
              <label for="default-input" class="block mb-2 text-sm font-medium text-amber-600">Pilih role yang ingin kamu tempati:</label>
            ...
            <div class="flex justify-evenly">
              ...
              <button data-modal-hide="popup-modal-req" type="button" class="text-gray-500 bg-white hover:bg-red-500 focus:ring-4 focus:outline-none focus:ring-red-200 rounded-lg border hover:border-red-500 border-gray-200 text-sm font-medium px-5 py-2.5 hover:text-white focus:z-10 ">Batalkan permintaan</button>
            </div>
          </div>
        </form>
