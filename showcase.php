            ...
            <form>
                <div class="flex">
                    ...
                    <div class="relative w-full">
                        <input type="search" id="search-dropdown" class="block p-2.5 w-full z-20 text-sm text-gray-900 bg-gray-50 rounded-r-lg border-l-gray-300 border-l-2 ease-in-out duration-500 border border-gray-300 focus:ring-amber-500 focus:border-amber-500" placeholder="Cari Proyek." required>
  ...
  <section class="bg-gray-50">
    <div class="py-8 px-4 mx-auto max-w-screen-xl text-center lg:py-20 lg:px-12">
        ...
        <div class="flex flex-col mb-8 lg:mb-16 space-y-4 sm:flex-row sm:justify-center sm:space-y-0 sm:space-x-4">
            <a href="#" class="inline-flex justify-center items-center py-3 px-5 text-base font-medium text-center text-amber-500 rounded-lg bg-primary-700 hover:bg-amber-500 hover:text-white ease-in duration-300 focus:ring-4 focus:ring-primary-300">
                Lihat Proyek Lainnya
                <svg class="ml-2 -mr-1 w-5 h-5" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" d="M10.293 3.293a1 1 0 011.414 0l6 6a1 1 0 010 1.414l-6 6a1 1 0 01-1.414-1.414L14.586 11H3a1 1 0 110-2h11.586l-4.293-4.293a1 1 0 010-1.414z" clip-rule="evenodd"></path></svg>
            </a>
            <a href="#" class="inline-flex justify-center items-center py-3 px-5 text-base font-medium text-center text-amber-500 hover:text-white rounded-lg border border-amber-300 hover:bg-amber-500 focus:ring-4 focus:ring-amber-100 ease-in-out duration-300">
