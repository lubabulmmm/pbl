<div class="flex flex-col">
  <div class="flex mb-1.5">
    <div class="w-9/12 h-full text-sm flex items-center px-3 py-2 border-2 border-red-200 mr-2 rounded-lg">To Do</div>
...
<div class="flex flex-col">
  <div class="flex mb-1.5">
    <div class="w-9/12 h-full text-sm flex items-center px-3 py-2 border-2 border-amber-200 mr-2 rounded-lg">Doing</div>
...
<div class="flex flex-col">
  <div class="flex mb-1.5">
    <div class="w-9/12 h-full text-sm flex items-center px-3 py-2 border-2 border-green-200 mr-2 rounded-lg">Done</div>
