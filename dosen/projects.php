...
try {
  ...
  $get_submit_links = execThis("SELECT * FROM bunch WHERE bunch_id =" . $_GET['bid']);
} catch (\Throwable $th) {
  echo $th;
    ...
    <div class="rounded-lg mt-14 flex flex-col item-start">
      <div class="mx-auto w-full px-4 lg:px-12">
          ...
          <ol class="inline-flex items-center space-x-1 md:space-x-2 rtl:space-x-reverse">
            ...
            <li class="inline-flex items-center">
              <div class="flex items-center">
                ...
                <a href="./kelproj.php?id=<?= $_GET['id'] ?>" class="inline-flex items-center text-md lg:text-lg font-medium text-gray-700 hover:text-blue-800">
                  <span class="ms-1 text-md lg:text-lg font-medium text-gray-900 hover:text-blue-500 md:ms-2">Daftar Kelompok</span>
                </a>
              </div>
            </li>
            <li aria-current="page">
              <div class="flex items-center">
                ...
                <span class="ms-1 text-md lg:text-lg font-medium text-blue-500 md:ms-2">Detail Kelompok</span>
              </div>
            </li>
          </ol>
        </nav>
        ...
        <div class="w-full flex items-center my-2 flex-wrap">
          <a href="./kelproj.php?id=<?= $_GET['id'] ?>" type="button" class="shadow text-red-500 hover:text-red-400 focus:ring-4 focus:outline-none focus:ring-red-300 font-medium rounded-lg text-xs px-4 py-2 text-center inline-flex items-center me-2 my-2">
          ...
          <a href="/PBL/dosen/details-anggota.php?bid=<?= $_GET['bid'] ?>&id=<?= $_GET['id'] ?>" type="button" class="shadow text-blue-500 hover:text-blue-400 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-xs px-4 py-2 text-center inline-flex items-center me-2 my-2">
        ...
        <div id="default-tab-content">
          <?php for ($i = 1; $i <= $week_num; $i++) : ?>
            ...
            ?>
            <div class="hidden rounded-lg grid gap-4 lg:gap-2 grid-cols-1 md:grid-cols-2 lg:grid-cols-3 pb-5 border-b border-gray-200 mb-7" id="data<?= $i ?>" role="tabpanel" aria-labelledby="data<?= $i ?>-tab">
